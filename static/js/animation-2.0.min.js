...
function t_animate__checkAnimationAvailability() {
    var t = (e = document.querySelector(".t-records")) ? e.getAttribute("data-blocks-animationoff") : null,
        e = e ? e.getAttribute("data-tilda-mode") : null;
    return !/Bot/i.test(navigator.userAgent) && "yes" !== t && !t_animate__checkIE() && "edit" !== e || (e = document.querySelectorAll(".t-animate"), Array.prototype.forEach.call(e, (function(t) {
        t.classList.remove("t-animate")
    })), !1)
}
...
function t_animate__generateStyles() {
    if (document.querySelector(".t396")) {
        ...
        for (e += '.t396 .t-title.t-animate {-webkit-transition-duration: 1.2s;transition-duration: 1.2s;}.t396 .t-descr.t-animate,.t396 .t-uptitle.t-animate,.t396 .t-subtitle.t-animate,.t396 .t-text.t-animate {-webkit-transition-duration: 0.7s;transition-duration: 0.7s;}.t396 .t-item.t-animate {-webkit-transition-duration: 0.5s;transition-duration: 0.5s;}.t396 .t-animate[data-animate-style="fadein"] {opacity: 0;transform: none;}', a = 0; a < t.length; a++)(n = t_animate__getMediaQuery(t, a)).isContinue || (e += n.text + "#allrecords .t396 .t-animate[data-animate-style-res-" + n.minRes + '="fadein"] {opacity: 0;transform: none;}}');
        for (e += '.t396 .t-animate_started[data-animate-style="fadein"] {opacity: 1;}', a = 0; a < t.length; a++)(n = t_animate__getMediaQuery(t, a)).isContinue || (e += n.text + "#allrecords .t396 .t-animate_started[data-animate-style-res-" + n.minRes + '="fadein"] {opacity: 1;}}');
        for (e += '.t396 .t-animate[data-animate-style="fadeinup"] {-webkit-transform: translate(0, 100px);transform: translate(0, 100px);}', a = 0; a < t.length; a++)(n = t_animate__getMediaQuery(t, a)).isContinue || (e += n.text + "#allrecords .t396 .t-animate[data-animate-style-res-" + n.minRes + '="fadeinup"] {-webkit-transform: translate(0, 100px);transform: translate(0, 100px);}}');
        for (e += '.t396 .t-animate_started[data-animate-style="fadeinup"] {opacity: 1;-webkit-transform: none;transform: none;}', a = 0; a < t.length; a++)(n = t_animate__getMediaQuery(t, a)).isContinue || (e += n.text + "#allrecords .t396 .t-animate_started[data-animate-style-res-" + n.minRes + '="fadeinup"] {opacity: 1;-webkit-transform: none;transform: none;}}');
        for (e += '.t396 .t-animate[data-animate-style="fadeindown"] {-webkit-transform: translate(0, -100px);transform: translate(0, -100px);}', a = 0; a < t.length; a++)(n = t_animate__getMediaQuery(t, a)).isContinue || (e += n.text + "#allrecords .t396 .t-animate[data-animate-style-res-" + n.minRes + '="fadeindown"] {-webkit-transform: translate(0, -100px);transform: translate(0, -100px);}}');
        for (e += '.t396 .t-animate_started[data-animate-style="fadeindown"] {opacity: 1;-webkit-transform: none;transform: none;}', a = 0; a < t.length; a++)(n = t_animate__getMediaQuery(t, a)).isContinue || (e += n.text + "#allrecords .t396 .t-animate_started[data-animate-style-res-" + n.minRes + '="fadeindown"] {opacity: 1;-webkit-transform: none;transform: none;}}');
        for (e += '.t396 .t-animate[data-animate-style="fadeinleft"] {-webkit-transform: translate(100px, 0);transform: translate(100px, 0);}', a = 0; a < t.length; a++)(n = t_animate__getMediaQuery(t, a)).isContinue || (e += n.text + "#allrecords .t396 .t-animate[data-animate-style-res-" + n.minRes + '="fadeinleft"] {-webkit-transform: translate(100px, 0);transform: translate(100px, 0);}}');
        for (e += '.t396 .t-animate_started[data-animate-style="fadeinleft"] {opacity: 1;-webkit-transform: none;transform: none;}', a = 0; a < t.length; a++)(n = t_animate__getMediaQuery(t, a)).isContinue || (e += n.text + "#allrecords .t396 .t-animate_started[data-animate-style-res-" + n.minRes + '="fadeinleft"] {opacity: 1;-webkit-transform: none;transform: none;}}');
        for (e += '.t396 .t-animate[data-animate-style="fadeinright"] {-webkit-transform: translate(-100px, 0);transform: translate(-100px, 0);}', a = 0; a < t.length; a++)(n = t_animate__getMediaQuery(t, a)).isContinue || (e += n.text + "#allrecords .t396 .t-animate[data-animate-style-res-" + n.minRes + '="fadeinright"] {-webkit-transform: translate(-100px, 0);transform: translate(-100px, 0);}}');
        for (e += '.t396 .t-animate_started[data-animate-style="fadeinright"] {opacity: 1;-webkit-transform: none;transform: none;}', a = 0; a < t.length; a++)(n = t_animate__getMediaQuery(t, a)).isContinue || (e += n.text + "#allrecords .t396 .t-animate_started[data-animate-style-res-" + n.minRes + '="fadeinright"] {opacity: 1;-webkit-transform: none;transform: none;}}');
        for (e += '.t396 .t-animate[data-animate-style="zoomin"] {-webkit-transform: scale(0.9);transform: scale(0.9);}', a = 0; a < t.length; a++)(n = t_animate__getMediaQuery(t, a)).isContinue || (e += n.text + "#allrecords .t396 .t-animate[data-animate-style-res-" + n.minRes + '="zoomin"] {-webkit-transform: scale(0.9);transform: scale(0.9);}}');
        for (e += '.t396 .t-animate_started[data-animate-style="zoomin"] {opacity: 1;-webkit-transform: scale(1);transform: scale(1);}', a = 0; a < t.length; a++)(n = t_animate__getMediaQuery(t, a)).isContinue || (e += n.text + "#allrecords .t396 .t-animate_started[data-animate-style-res-" + n.minRes + '="zoomin"] {opacity: 1;-webkit-transform: scale(1);transform: scale(1);}}');
        for (e += '.t396 .t-animate[data-animate-style="zoomout"] {-webkit-transform: scale(1.2);transform: scale(1.2);}', a = 0; a < t.length; a++)(n = t_animate__getMediaQuery(t, a)).isContinue || (e += n.text + "#allrecords .t396 .t-animate[data-animate-style-res-" + n.minRes + '="zoomout"] {-webkit-transform: scale(1.2);transform: scale(1.2);}}');
        for (e += '.t396 .t-animate_started[data-animate-style="zoomout"] {opacity: 1;-webkit-transform: scale(1);transform: scale(1);}', a = 0; a < t.length; a++)(n = t_animate__getMediaQuery(t, a)).isContinue || (e += n.text + "#allrecords .t396 .t-animate_started[data-animate-style-res-" + n.minRes + '="zoomout"] {opacity: 1;-webkit-transform: scale(1);transform: scale(1);}}');
        ...
        var n;
        for (a = 0; a < t.length; a++)(n = t_animate__getMediaQuery(t, a)).isContinue || (e += n.text + "#allrecords .t396 .t-animate_started[data-animate-distance-res-" + n.minRes + "],#allrecords .t396 .t-animate_started[data-animate-style-res-" + n.minRes + '="zoomout"] {-webkit-transform: none !important;transform: none !important;}}');
...
function t_animate__getBreakpointsArr() {
    var t = [],
        e = Array.prototype.slice.call(document.querySelectorAll('.r[data-record-type="396"]:not(.t397__off):not(.t395__off):not(.t400__off) .t396__artboard'));
    return Array.prototype.forEach.call(e, (function(e) {
        e.classList.contains("t396__artboard") && (e = (e = (e = (e = e.getAttribute("data-artboard-screens")) ? e.split(",") : [1200, 960, 640, 480, 320]).map((function(t) {
...
function t_animate__startAnimation() {
    var t, e, a, n = document.querySelectorAll(".r"),
    ...
    window.innerWidth < 1200 && (i = t_animate__checkMobile(i), r = t_animate__checkMobile(r), o = t_animate__checkMobile(o)), (i.length || o.length || r.length) && (t_animate__setAnimationState(i, r, o), i = t_animate__hasWaitAnimation(i), o = t_animate__hasWaitAnimation(o), r = t_animate__hasWaitAnimation(r), t = "undefined" != typeof navigator && /^((?!chrome|android).)*(safari|mobile)/i.test(navigator.userAgent) && /(os |version\/)15(.|_)[4-9]/i.test(navigator.userAgent), "IntersectionObserver" in window && !t ? (i.length && (e = [], i.forEach((function(t) {
        var a = t.querySelector(".t-animate");
        "fadeindown" === a.getAttribute("data-animate-style") && (!a.closest(".t-cover") || (t = t.querySelector(".t-animate:not(:first-child)")) && (a = t)), e.push(a)
    })), e.forEach((function(t) {
        new IntersectionObserver((function(t, e) {
            t.forEach((function(t) {
                var a;
                t.isIntersecting && (a = t.target, e.unobserve(a), t = a.closest(".r").querySelectorAll(".t-animate"), t = Array.prototype.filter.call(t, (function(t) {
                    return !(t.classList.contains("t-animate__btn-wait-chain") || "yes" === t.getAttribute("data-animate-chain"))
                })), t_animate__makeSectionButtonWait(a), t_animate__saveSectionHeaderStartTime(a), Array.prototype.forEach.call(t, (function(t) {
        ...
        a && (e.rootMargin = "0px 0px " + -1 * a.replace("px", "") + "px 0px"), e = new IntersectionObserver((function(t, e) {
            t.forEach((function(t) {
                var a, n = t.target;
                !n.demandTransform && n.style.transform ? (n.demandTransform = n.style.transform, n.style.transform = "unset") : (a = window.getComputedStyle(n).transform, n.style.transform || "none" === a || (n.demandTransform = a, n.style.transform = "unset")), t.isIntersecting && (e.unobserve(n), t = -1 !== (t = n.style.transitionDelay || "0ms").indexOf("ms") ? parseInt(t) + 250 : 1e3 * parseFloat(t) + 250, n.demandTransform && -1 !== n.demandTransform.indexOf("matrix") && (n.style.transform = ""), n.demandTransform && "unset" === n.style.transform && (n.style.transform = n.demandTransform, delete n.demandTransform), setTimeout((function() {
                    n.classList.remove("t-animate_wait"), t_animate__removeNoHoverClassFromBtns(n), n.classList.add("t-animate_started"), "animatednumber" === t_animate__getAttrByResBase(n, "style") && t_animate__animateNumbers(n)
                }), t))
            }))
        }), e), t.dataset.observerReady = !0, e.observe(t)
    })), r.length && ((a = function() {
        t_animate__getChainOffsets(r)
    })(), window.addEventListener("resize", t_throttle((function() {
        a()
    }))), setInterval(a, 5e3), window.addEventListener("scroll", t_throttle((function() {
    ...
    })(), window.addEventListener("resize", t_throttle(a)), setInterval(a, 5e3), window.addEventListener("scroll", t_throttle((function() {
        var t = t_animate__deleteAnimatedEls(i, o);
        o = t[0], (t = t_animate__animateOnScroll(i = t[1], r, o)) && t.length && (i = t[0], r = t[1], o = t[2])
    })))), Array.prototype.forEach.call(n, (function(t) {
        var e = t.querySelector(".t-popup");
        e && e.addEventListener("scroll", t_throttle((function() {
            var t, a = window.pageYOffset + window.innerHeight;
            (e.classList.contains("t-animate") && "yes" === e.getAttribute("data-animate-chain") || e.querySelector(".t-animate[data-animate-chain=yes]")) && (t_animate__setAnimationStateChains(t = [e]), t_animate__getChainOffsets(t = Array.prototype.filter.call(t, (function(t) {
                return t.querySelector(".t-animate_wait")
            }))), t_animate__animateChainsBlocks(t, a))
        })))
    })))
}
...
function t_animate__animateGroups(t, e) {
    return t.forEach((function(t) {
        var a;
        t.curTopOffset < e && (a = t.querySelectorAll(".t-animate"), a = Array.prototype.filter.call(a, (function(t) {
            return !(t.classList.contains("t-animate__btn-wait-chain") || "yes" === t.getAttribute("data-animate-chain"))
        })), t_animate__makeSectionButtonWait(t), t_animate__saveSectionHeaderStartTime(t), Array.prototype.forEach.call(a, (function(t) {
            t.classList.remove("t-animate_wait"), t_animate__removeNoHoverClassFromBtns(t), t.classList.add("t-animate_started")
        })))
    })), t
}
...
function t_animate__animateElems(t, e, a) {
    return Array.prototype.filter.call(t, (function(t) {
        ...
        return t.curTopOffset < n ? (t.classList.remove("t-animate_wait"), t_animate__removeNoHoverClassFromBtns(t), t.classList.add("t-animate_started"), "animatednumber" === t_animate__getAttrByResBase(t, "style") && t_animate__animateNumbers(t), !0) : !(t.curTopOffset < a) && void 0
    })), t
}
...
function t_animate__animateChainItemsOnScroll(t, e) {
    var a = t.querySelectorAll(".t-animate_wait[data-animate-chain=yes]"),
        n = (a = Array.prototype.slice.call(a), 0),
        i = 0,
        r = t.itemsOffsets[0],
...
function t_animate__getSectionHeadDealy(t) {
    ...
    t = 0;
    return e && (e = e.getAttribute("data-animate-start-time") || 0, Date.now() - e <= 160) || a && (a = a.getAttribute("data-animate-start-time") || 0, Date.now() - a <= 160) ? .16 : t
}
...
function t_animate__getDelayFromPreviousScrollEvent(t, e) {
    ...
    return a || !t.length ? 0 : t.length ? (t = (t[t.length - 1].getAttribute("data-animate-start-time") || 0) - Date.now()) <= 0 ? e : t / 1e3 + e : void 0
}
...
function t_animate__animateNumbers(t) {
    ...
    var i, r = [],
        o = null;
    e && (o = e.match(/\d+\.\d+|\d+,\d+/g), i = e.match(/\d+/g), e.replace(/(\d)(?= \d) /g, "$1").split(" ").forEach((function(t) {
        isNaN(parseInt(t.replace(/[^\d., ]+/g, ""), 10)) || r.push(t.replace(/[^\d., ]+/g, ""))
    })));
    var s = 0,
        l = !1,
        m = !1;
    t.removeAttribute("data-animate-number-count"), null !== o && (m = -1 !== o[0].indexOf(",")), r.forEach((function(t, e) {
        var a;
        null !== o && (-1 !== t.indexOf(",") && (a = t.split(",")), -1 !== t.indexOf(".") && (a = t.split(".")), -1 === t.indexOf(",") && -1 === t.indexOf(".") || (s = a[1].length, r[e] = +a.join("."), l = !0))
    }));
    var c, _, d, f, u, y = t.querySelector(".t-animate__number");
    r[0] && (c = Number(r[0]) || 0, _ = 0, d = Math.pow(10, s), l && (c *= d, _ *= d), f = 0, u = setInterval((function() {
        var n;
        _ += c / 108, f = l ? (Math.round(_) / d).toFixed(s) + "" : Math.floor(_) + "", 1 < i.length && (f = f.replace(/(\d)(?=(\d{3})+([^\d]|$))/g, "$1 ")), m && (f = f.replace(/\./g, ",")), y && (y.textContent = f), c <= _ && (clearInterval(u), t.innerHTML = e, n = t.querySelectorAll("span"), Array.prototype.forEach.call(n, (function(t) {
...
function t_animate__setAnimELemsState(t, e, a) {
    t.forEach((function(t) {
        ...
        if (n < e - 500) return t.classList.remove("t-animate"), t.classList.remove("t-animate_no-hover"), "animatednumber" === t_animate__getAttrByResBase(t, "style") && t_animate__animateNumbers(t), !0;
        var i = t_animate__detectElemTriggerOffset(t, a);
        t_animate__setCustomAnimSettings(t, n, a), n < i && (t_animate__removeNoHoverClassFromBtns(t), t.classList.add("t-animate_started"), "animatednumber" === t_animate__getAttrByResBase(t, "style") && t_animate__animateNumbers(t)), i <= n && t.classList.add("t-animate_wait")
    }))
}
...
function t_animate__setGroupsBlocksState(t, e, a) {
    t.forEach((function(t) {
        var n = t.querySelectorAll(".t-animate"),
            i = (n = Array.prototype.filter.call(n, (function(t) {
        ...
        t_animate__assignGroupDelay(t, r), Array.prototype.forEach.call(n, (function(n) {
            ...
            if (n.classList.contains("t-animate_no-hover") && r && n.classList.remove("t-animate_no-hover"), i <= e - 100) return t_animate__saveSectionHeaderStartTime(t), n.classList.remove("t-animate"), n.classList.remove("t-animate_no-hover"), !(n.style.transitionDelay = "");
            i < a && e - 100 < i && (t_animate__makeSectionButtonWait(t), n.classList.contains(".t-animate__btn-wait-chain") || (t_animate__removeNoHoverClassFromBtns(n), r ? n.classList.add("t-animate_wait") : n.classList.add("t-animate_started"))), a <= i && n.classList.add("t-animate_wait")
        }))
    }))
}
...
function t_animate__assignOrderedElemsDelay(t, e) {
    ...
    e = t.querySelectorAll('.t-animate[data-animate-order="8"]'), t = t.querySelectorAll('.t-animate[data-animate-order="9"]');
...
function t_animate__assignChainDelay(t, e, a) {
    var n, i, r, o = t.querySelectorAll(".t-animate[data-animate-chain=yes]"),
        s = 0;
    o.length && (n = o[0], i = n.getBoundingClientRect().top + window.pageYOffset, n.classList.add("t-animate__chain_first-in-row"), r = t_animate__getCurBlockSectionHeadDelay(t), Array.prototype.forEach.call(o, (function(l) {
        var m = l.getBoundingClientRect().top + window.pageYOffset;
        if (m < a) return l.classList.remove("t-animate"), !0;
        m < e ? (m !== i && (l.classList.add("t-animate__chain_first-in-row"), i = m), m = .16 * s + r, l.style.transitionDelay = m + "s", l.classList.add("t-animate_started"), l.setAttribute("data-animate-start-time", Date.now() + 1e3 * m), n === o[o.length - 1] && t_animate__checkSectionButtonAnimation(t, m), s++, ["transitionend", "webkitTransitionEnd", "oTransitionEnd", "otransitionend", "MSTransitionEnd"].forEach((function(t) {
            l.addEventListener(t, (function() {
                t_animate__addEventOnAnimateChain(l)
            })), l.removeEventListener(t, (function() {
                t_animate__addEventOnAnimateChain(l)
            }))
        }))) : l.classList.add("t-animate_wait")
    })))
}

function t_animate__getAttrByResBase(t, e) {
    var a;
    if (!(r = t.closest(".t396__artboard"))) return t.getAttribute("data-animate-" + e);
    var n, i, r = "ab" + r.getAttribute("data-artboard-recid"),
        o = void 0 !== window.tn[r] ? (n = window.tn[r].curResolution, i = window.tn[r].curResolution_max, window.tn[r].screens.slice()) : (n = window.tn.curResolution, [320, 480, 640, 960, i = 1200]);
    r = (r = t.closest(".t396__elem")) ? r.getAttribute("data-animate-mobile") : null;
    if (n === i) a = t.getAttribute("data-animate-" + e);
    else {
        if ("y" !== r && n < 1200) return t.style.transition = "none", null;
        a = t.getAttribute("data-animate-" + e + "-res-" + n)
    }
    if (!a && "" !== a)
        for (var s = 0; s < o.length; s++) {
            var l = o[s];
            if (!(l <= n) && (a = l === i ? t.getAttribute("data-animate-" + e) : t.getAttribute("data-animate-" + e + "-res-" + l))) break
        }
    return a
}
...
function t_animate__setCustomAnimSettings(t, e, a) {
    ...
    }(n = t_animate__getAttrByResBase(t, "scale")) && (t.style.transitionDuration = "0s", t.style.transitionDelay = "0s", t.style.transform = "scale(" + n + ")", t_animate__forceElemInViewPortRepaint(t, e, a), t.style.transitionDuration = "", t.style.transitionDelay = ""), (a = t_animate__getAttrByResBase(t, "delay")) && (t.style.transitionDelay = a + "s"), (a = t_animate__getAttrByResBase(t, "duration")) && (t.style.transitionDuration = a + "s")
}
...
function t_animate__checkSectionButtonAnimation(t, e) {
    (t = t.querySelectorAll(".t-animate__btn-wait-chain")).length && Array.prototype.forEach.call(t, (function(t) {
...
function t_animation__getZoom(t) {
    ...
    return e ? (t = document.querySelector('script[src*="tilda-blocks-2.7"]'), e.classList.contains("t396__artboard_scale") || !t && "undefined" != typeof t396_ab__getFieldValue && "window" === t396_ab__getFieldValue(e, "upscale") ? window.tn_scale_factor : 1) : 1
}
...
function t_animate__removeAnimFromHiddenSlides(t) {
    ...
    t.querySelectorAll(".t-slides").length && (t = t.querySelectorAll(".t-slides__item"), t = Array.prototype.filter.call(t, (function(t) {
        ...
        (t = t.querySelector(".t-animate")) && e.push(t)
    })), e.forEach((function(t) {
...
function t_animate__wrapTextWithOpacity() {
    ...
    Array.prototype.forEach.call(t, (function(t) {
        ...
        !a || -1 === a.indexOf("opacity") || (a = t.style.opacity) && 0 < a && (t.style.opacity = "", (e = document.createElement("div")).style.opacity = a, a = t.childNodes, Array.prototype.forEach.call(a, (function(t) {
            t = t.cloneNode(!0), e.appendChild(t)
