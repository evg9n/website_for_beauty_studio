...
function t_outerWidth(t) {
    var e, n = (e = getComputedStyle(t)).width;
    return "auto" === n && (n = 0), "auto" === (t = e.marginLeft) && (t = 0), "auto" === (e = e.marginRight) && (e = 0), parseInt(n) + parseInt(t) + parseInt(e)
}
var version;
...
function t_onFuncLoad(t, e, n) {
    var i, o;
    "function" == typeof window[t] ? e() : (i = Date.now(), o = new Error(t + " is undefined"), setTimeout((function a() {
        var r = Date.now();
        "function" != typeof window[t] ? ("complete" === document.readyState && 5e3 < r - i && "function" != typeof window[t] && function() {
            throw o
        }(), setTimeout(a, n || 100)) : e()
    })))
}
...
function t_scrollBarWidthCompensator__setObject() {
    ...
    t.isInited = !1, t.scrollBarWidth = Math.abs(window.innerWidth - document.documentElement.clientWidth), t.delay = 0;
    var e = document.querySelectorAll("*");
    t.fixedElements = [], Array.prototype.forEach.call(e, (function(e) {
        var n, i, o, a;
        e.classList.contains("t975") || (i = (n = window.getComputedStyle(e)).getPropertyValue("position"), o = n.getPropertyValue("width"), a = n.getPropertyValue("height"), o = "100%" === o || o === window.innerWidth + "px" || o === window.innerWidth - t.scrollBarWidth + "px" || "100vw" === o, a = "100%" === a || a === window.innerHeight + "px" || a === window.innerHeight - t.scrollBarWidth + "px" || "auto" === a || "100vh" === a, ("fixed" === i || "absolute" === i && o && !a) && t.fixedElements.push({
            el: e,
            computedStyle: n
        }))
    }))
...
function t_scrollBarWidthCompensator__init() {
    ...
    var t, e, n, i = window.scrollBarWidthCompensator;
    i.scrollBarWidth = Math.abs(window.innerWidth - document.documentElement.clientWidth), !i.isInited && i.scrollBarWidth && (i.isInited = !0, t = window.getComputedStyle(document.body).getPropertyValue("padding-right"), t = parseInt(t.replace("px", ""), 10), (e = document.body.style.paddingRight) && document.body.setAttribute("data-tilda-initial-padding-right", e), document.body.style.paddingRight = i.scrollBarWidth + t + "px", document.body.style.height = "100vh", document.body.style.minHeight = "100vh", document.body.style.overflow = "hidden", n = [], Array.prototype.forEach.call(i.fixedElements, (function(t) {
        var e, o, a, r, d = t.el;
        !document.body.contains(d) || d.classList.contains("t975") || d.classList.contains("t975") || "fixed" !== (e = (a = t.computedStyle).getPropertyValue("position")) && "absolute" !== e || ((r = a.getPropertyValue("transition-duration")).indexOf("ms") + 1 ? (r = parseInt(r.replace("ms", ""), 10), n.push(r)) : r.indexOf("s") + 1 && (r = 1e3 * parseFloat(r.replace("s", "")), n.push(r)), o = a.getPropertyValue("right"), o = parseInt(o.replace("px", ""), 10), t = a.getPropertyValue("width"), r = a.getPropertyValue("height"), (a = d.style.right) && d.setAttribute("data-tilda-initial-right", a), (a = d.style.width) && d.setAttribute("data-tilda-initial-width", a), t = "100%" === t || t === window.innerWidth + "px" || t === window.innerWidth - i.scrollBarWidth + "px" || "100vw" === t, r = "100%" === r || r === window.innerHeight + "px" || r === window.innerHeight - i.scrollBarWidth + "px" || "auto" === r || "100vh" === r, !o && 0 !== o || "auto" === d.style.right || "absolute" === e || t ? t && !r && (d.style.width = "calc(100vw - " + i.scrollBarWidth + "px)") : d.style.right = i.scrollBarWidth + o + "px")
    })), n.length && (i.delay = Math.max.apply(null, n)))
}
...
function t_scrollBarWidthCompensator__cancel() {
    ...
    t && t.isInited && (t.isInited = !1, t.delay = 0, document.body.hasAttribute("data-tilda-initial-padding-right") ? (document.body.style.paddingRight = document.body.getAttribute("data-tilda-initial-padding-right"), document.body.removeAttribute("data-tilda-initial-padding-right")) : document.body.style.removeProperty("padding-right"), document.body.style.removeProperty("height"), document.body.style.removeProperty("min-height"), document.body.style.removeProperty("overflow"), Array.prototype.forEach.call(t.fixedElements, (function(t) {
        (t = t.el).hasAttribute("data-tilda-initial-right") ? (t.style.right = t.getAttribute("data-tilda-initial-right"), t.removeAttribute("data-tilda-initial-right")) : t.style.removeProperty("right"), t.hasAttribute("data-tilda-initial-width") ? (t.style.width = t.getAttribute("data-tilda-initial-width"), t.removeAttribute("data-tilda-initial-width")) : t.style.removeProperty("width")
    })))
}
window.isSearchBot = !1, /Bot/i.test(navigator.userAgent) && (window.isSearchBot = !0), window.isMobile = !1, window.$isMobile = !1, /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && (window.isMobile = !0, window.$isMobile = !0), window.isTablet = /(ipad|tablet|(android(?!.*mobile))|(windows(?!.*phone)(.*touch))|kindle|playbook|silk|(puffin(?!.*(IP|AP|WP))))/i.test(navigator.userAgent), window.isiOS = !1, /iPhone|iPad|iPod/i.test(navigator.userAgent) && (window.isiOS = !0), window.isiOSChrome = !!navigator.userAgent.match("CriOS"), window.isFirefox = /firefox/i.test(navigator.userAgent), window.isOpera = !!window.opr && !!window.opr.addons || !!window.opera || 0 <= navigator.userAgent.indexOf(" OPR/"), window.isiOSVersion = "", window.isiOS && null !== (version = navigator.appVersion.match(/OS (\d+)_(\d+)_?(\d+)?/)) && (window.isiOSVersion = [parseInt(version[1], 10), parseInt(version[2], 10), parseInt(version[3] || 0, 10)]), window.isSafari = !1, /^((?!chrome|android).)*safari/i.test(navigator.userAgent) && (window.isSafari = !0), window.isIE = !!document.documentMode, window.isSafariVersion = "", window.isSafari && null !== (version = navigator.appVersion.match(/Version\/(\d+)\.(\d+)\.?(\d+)? Safari/)) && (window.isSafariVersion = [parseInt(version[1], 10), parseInt(version[2], 10), parseInt(version[3] || 0, 10)]), window.browserLang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2), window.tildaBrowserLang = window.browserLang, t_onReady((function() {
        ...
        if (!window.isMobile && t && "yes" !== t.getAttribute("data-blocks-animationoff") && !1 === window.isSearchBot) {
            ...
            var o, a, r, d, l = Array.prototype.slice.call(e).filter((function(t) {
        ...
        var p = document.querySelector("html"),
            m = document.body;
        "none" === p.style.display && (p.style.display = "block"), t = document.querySelector(".t-tildalabel"), (p = m ? Math.max(m.scrollHeight, m.offsetHeight, m.clientHeight, p.offsetHeight) : p.offsetHeight) + 70 < window.innerHeight ? t && (t.style.display = "none") : t && t.setAttribute("style", "display: block !important")
    })),
    function() {
        function t() {
    ...
    function() {
        ...
        function e() {
            ...
            var d, l, s = document.querySelectorAll("[data-height-correct-vh]"),
                c = window.innerHeight;
            for (a = 0, r = 0; r < s.length; r++) - 1 < (l = (d = s[r]).style).height.indexOf("vh") && (a = parseInt(l.height) / 100, t = c + "px", l.height = t)
        }
        ...
        function n() {
            ...
            for (var n = document.querySelectorAll('.r:not([data-record-type="396"]):not([data-record-type="1003"])'), i = [], o = 0; o < n.length; o++) {
                ...
                "none" !== r.display && "hidden" !== r.visibility && "0" !== r.opacity && i.push(a)
            }
            for (var d = 0; d < i.length; d++)
                for (var l = i[d], s = l.querySelectorAll('div:not([data-auto-correct-mobile-width="false"]):not(.tn-elem):not(.tn-atom):not(.tn-atom__sbs-anim-wrapper):not(.tn-atom__prx-wrapper):not(.tn-atom__videoiframe):not(.tn-atom__sticky-wrapper):not(.t-store__relevants__container):not(.t-slds__items-wrapper):not(.js-product-controls-wrapper):not(.js-product-edition-option):not(.t-product__option-variants)'), c = 0; c < s.length; c++) {
                    ...
                    if (e < h) {
                        ...
                        console.log("Block not optimized for mobile width. Block width:" + h + " Block id:" + l.getAttribute("id")), console.log(u), l.style.overflow = "auto", l.style.wordBreak = e < h - 3 ? "break-word" : ""
                    }
                }
        }
        ...
        function i(t) {
            ...
            for (var t = document.querySelectorAll('[data-customstyle="yes"]'), e = document.querySelectorAll("[field] span, [field] strong, [field] em"), n = 0; n < t.length; n++) {
                var o = t[n];
                26 < parseInt(getComputedStyle(o).fontSize.replace("px", "")) && (o.style.fontSize = null, o.style.lineHeight = null)
            }
            for (n = 0; n < e.length; n++) o = e[n], 26 < parseInt(getComputedStyle(o).fontSize.replace("px", "")) && (o.style.fontSize = null);
            ...
            for (n = 0; n < e.length; n++) i = e[n], 30 < parseInt(getComputedStyle(i).fontSize.replace("px", "")) && (i.style.fontSize = null);
            var o = document.querySelectorAll('.t-text:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"]), .t-name:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"]), .t-title:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"]), .t-descr:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"]), .t-heading:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"]), .t-text-impact:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"]), .t-subtitle:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"]), .t-uptitle:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"])');
