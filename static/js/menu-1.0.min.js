function t_menu__highlightActiveLinks(e) {
    ...
    "/" === n[n.length - 1] && (t = n.slice(0, -1)), "/" === r[r.length - 1] && (r = r.slice(0, -1)), "/" === r[0] && (r = r.slice(1)), "" === r && (r = "/");
    var i = document.querySelectorAll(e);
    Array.prototype.forEach.call(i, (function(e) {
        var i = e.getAttribute("href");
        if (i) {
            var o = e.href;
            o !== n && o !== r && i !== n && i !== r && t !== n && t !== r || e.classList.add("t-active")
        }
    }))
}
...
function t_menu__showFixedMenu(e, t) {
    ...
    if (!(window.innerWidth <= 980) || n) {
        var r = document.getElementById("rec" + e);
        if (!r) return !1;
        var i = r.querySelectorAll(t);
        Array.prototype.forEach.call(i, (function(e) {
    ...
    if (n) {
        ...
        if (a)
            if (r && r.classList.contains(t.slice(1) + "__mobile_burgerhook") && i) {
                ...
                else if (a.querySelector(".t-menuburger")) u = a.querySelector(".t-menuburger");
                if (u) {
                ...
                u = a.querySelector(".t-menuburger");
            ...
            if (r && r.classList.contains("tmenu-mobile__menucontent_fixed")) {
                ...
                i && (["t978__menu-link_hook", "t978__tm-link", "t966__tm-link", "t794__tm-link", "t-menusub__target-link"].some((function(e) {
...
function t_menu_checkOverflow(e, t) {
    ...
    if (r) {
        var i = n.querySelector(t + "__mobile") || n.querySelector(".tmenu-mobile");
        if (i) {
            var o = i.offsetHeight,
                a = document.documentElement.clientHeight,
                l = r.style.position || window.getComputedStyle(r).position,
                s = r.offsetHeight;
            "fixed" === l && s > a - o && (r.style.overflow = "auto", r.style.maxHeight = "calc(100% - " + o + "px)")
        }
    }
}
...
function t_menu__FadeOut(e, t, n) {
    ...
    var i = setInterval((function() {
        e.style.opacity = r, (r -= .1) <= .1 && (e.style.opacity = "0", e.style.display = "none", "function" == typeof n && n(), clearInterval(i))
    }), t > 0 ? t / 10 : 40)
}
...
function t_menu__interactFromKeyboard(e) {
    ...
    if (t) {
        var n, r = t.querySelectorAll('[role="menubar"] > li > a'),
            i = t.querySelectorAll('[role="menubar"]  > li li'),
            o = 0,
            a = function(e) {
                e === r.length ? e = 0 : e < 0 && (e = r.length - 1), r[e].focus(), o = e
            },
            l = function(e, t) {
                var r = e.querySelectorAll("a");
                t == r.length ? t = 0 : t < 0 && (t = r.length - 1), r[t].focus(), n = t
            },
            s = function(e) {
                e.addEventListener("keydown", (function(t) {
                    var i = this.parentNode.querySelector(".t-menusub__list");
                    switch (t.keyCode) {
                        case 39:
                            a(o + 1);
                            break;
                        case 37:
                            ...
                            break;
                        case 9:
                            if (!t.shiftKey && o <= r.length - 2) a(o + 1);
                            else {
                                if (!(t.shiftKey && o > 0)) return void e.setAttribute("tabindex", "0");
                                a(o - 1)
                            }
                            break;
                        case 13:
                        ...
                        case 32:
                            if (!i) return;
                            this.click(), n = 0, l(i, 0);
                            break;
                        case 38:
                            if (!i) return;
                            this.click(), n = i.querySelectorAll("li").length - 1, l(i, n)
                    }
                    t.preventDefault()
                }))
            },
            u = function(e) {
                e.addEventListener("focus", (function() {
                    n = 0, Array.prototype.forEach.call(r, (function(e) {
                        e.hasAttribute("aria-haspopup") && e.setAttribute("aria-expanded", "false")
                    })), 0 !== o && 0 === Number(this.getAttribute("tabindex")) && this.setAttribute("tabindex", -1)
                }))
            };
        Array.prototype.forEach.call(r, (function(e, t) {
            0 == t ? e.setAttribute("tabindex", "0") : e.setAttribute("tabindex", "-1"), u(e), s(e), e.parentNode.querySelector(".t-menusub__menu") && !window.isMobile && function(e) {
                ...
                function(e) {
                    ...
                    e.addEventListener("keydown", (function(e) {
                        ...
                        switch (e.keyCode) {
                            case 9:
                                i = !0;
                                var u = s.querySelectorAll(".t-menusub__link-item").length;
                                if (e.shiftKey) 0 === n ? (a(o), t_menusub__hideSubmenu(t)) : l(s, n - 1);
                                else if (n === u - 1) {
                                    if (t_menusub__hideSubmenu(t), o === r.length - 1) return void r[o].setAttribute("tabindex", "0");
                                    a(o + 1)
                                } else l(s, n + 1);
                                break;
                            case 39:
                                i = !0, a(o + 1), t_menusub__hideSubmenu(t);
                                break;
                            case 37:
                                i = !0, a(o - 1), t_menusub__hideSubmenu(t);
                                break;
                            case 13:
                            case 32:
                                i = !1, t_menusub__hideSubmenu(t);
                                break;
                            case 27:
                                i = !0, a(o), t_menusub__hideSubmenu(t);
                                break;
                            case 40:
                                i = !0, l(s, n + 1);
                                break;
