function t_sldsInit(t, e) {
    ...
    if (s) {
        ...
        if (i && !i.getAttribute("data-slider-initialized")) {
            var r = i.classList.contains("js-feed-container"),
                a = s.querySelectorAll(".t-slds__item:not(.t-slds__item_dummy)");
            if (a) {
                var d = a.length,
                    l = a[0],
                    o = a[a.length - 1],
                    ...
                    _ = parseFloat(i.getAttribute("data-slider-transition")),
                    p = i.getAttribute("data-slider-stop"),
                    f = 1;
                if (Array.prototype.forEach.call(a, (function(t, e) {
                        t.setAttribute("data-slide-index", e + 1)
                    })), _ || 0 === _ || (_ = 300), "true" == p) return !1;
                isNaN(_) && i.setAttribute("data-slider-transition", "300"), i.classList.contains("t-slds_animated-fast") || i.classList.contains("t-slds_animated-slow") || i.classList.contains("t-slds_animated-none") || i.classList.add("t-slds_animated-fast");
                var y = c;
                ...
                var m = window.navigator.userAgent,
                    ...
                    g = "",
                    A = !1;
                v > 0 && (8 != (g = parseInt(m.substring(v + 5, m.indexOf(".", v)))) && 9 != g || (A = !0)), !0 === A && (i.classList.remove("t-slds_animated-fast"), i.classList.remove("t-slds_animated-slow"), i.classList.add("t-slds_animated-none"), i.classList.add("t-slds_ie"), i.setAttribute("data-slider-correct-height", "true"), i.setAttribute("data-slider-items-in-row", 1)), i.setAttribute("data-slider-initialized", "true"), i.getAttribute("data-slider-totalslides") || i.setAttribute("data-slider-totalslides", d);
                var b = i.getAttribute("data-slider-pos");
                b ? f = parseInt(b, 10) : i.setAttribute("data-slider-pos", 1), i.setAttribute("data-slider-curr-pos", 1), i.setAttribute("data-slider-cycle", ""), i.setAttribute("data-slider-animated", ""), r || t_slds__createDummies(l, o, i), c = parseInt(i.getAttribute("data-slider-items-in-row"), 10) || 0;
                var S = s.querySelectorAll(".t-slds__arrow_wrapper-right");
                S.length > 0 && Array.prototype.forEach.call(S, (function(t) {
                    t.style.display = "false" === u && d - c <= 0 ? "none" : ""
                })), r || t_slds_SliderWidth(t), "true" == i.getAttribute("data-slider-correct-height") && t_slds_SliderHeight(t), t_slds_SliderArrowsHeight(t), t_slds_ActiveSlide(t, f, d), t_slds_ActiveCaption(t, f, d), r ? n > 960 && ("true" === i.getAttribute("data-feeds-posts-loaded") ? (t_slds__initFeedsSlider(t, s, e), t_slds_initSliderControls(t, e)) : document.addEventListener("feedsLoadPosts", (function() {
                    t_slds__initFeedsSlider(t, s, e), t_slds_initSliderControls(t, e)
                }))) : (A || t_slds_onHammerLoad("Hammer", (function() {
                    t_slds_initSliderSwipe(t, d, n)
                })), t_slds_initSliderControls(t, e), t_slds_updateSlider(t)), i.getAttribute("data-slider-timeout") > 0 ? t_slds_initAutoPlay(t, f, d, e) : i.addEventListener("slideAutoplayTimerReady", (function() {
                    i.getAttribute("data-slider-timeout") > 0 && t_slds_initAutoPlay(t, f, d, e)
                })), s.querySelectorAll(".t-slds__item-loaded").length < d + 2 && t_slds_UpdateImages(t, f), "yes" == i.getAttribute("data-slider-arrows-nearpic") && t_slds_positionArrows(t);
                var h = s.querySelectorAll(".t-slds");
                h.length > 0 && Array.prototype.forEach.call(h, (function(t) {
                    t.style.visibility = ""
                })), t_slds__setTabindexForFocusableElements(t), s.removeEventListener("displayChanged", t_slds_updateOnDisplayChange), s.addEventListener("displayChanged", t_slds_updateOnDisplayChange(t, y)), r && (s.removeEventListener("displayChanged", t_slds_updateFeedsSliderOnResize), s.addEventListener("displayChanged", (function() {
                    t_slds_updateFeedsSliderOnResize(t, s, e)
                }))), window.addEventListener("resize", t_throttle((function() {
                    setTimeout((function() {
                        t_slds_setItemsInRow(t, y), t_slds_updateSlider(t), t_slds_positionArrows(t), r && t_slds_updateFeedsSliderOnResize(t, s, e)
                    }), 100)
                ...
                var w = document.querySelector("#allrecords");
                w && w.addEventListener("allRecPaddingInit", (function() {
...
function t_slds__removeAutoplayByVideo(t) {
    ...
    if (e) {
        ...
        s && s.getAttribute("data-slider-interval-id") && (s.setAttribute("data-slider-stopped", "yes"), s.setAttribute("data-slider-stopped-by-video", "y"))
    }
}
...
function t_slds__createDummies(t, e, s) {
    var i = s.querySelectorAll(".t-slds__item:not(.t-slds__item_dummy)").length,
        r = parseInt(s.getAttribute("data-slider-items-in-row"), 10) || 0,
        a = s.getAttribute("data-slider-with-cycle"),
        d = s.classList.contains("js-feed-container"),
        l = !1,
        o = !1;
    if (t) {
        var n = t.querySelector('[data-zoomable="yes"]');
        n && (l = !0, n.classList.contains("t-zoomable") && n.classList.remove("t-zoomable"), n.removeAttribute("data-zoomable"))
    }
    if (e) {
    ...
    if (e && 0 == s.querySelectorAll('.t-slds__item[data-slide-index="0"]').length) {
        var u = e.cloneNode(!0);
        u.setAttribute("data-slide-index", "0"), u.setAttribute("aria-hidden", "true");
        var _ = t.parentNode;
        _.insertBefore(u, t);
        var p = _.querySelectorAll('[data-slide-index="0"] [field]');
        p.length > 0 && Array.prototype.forEach.call(p, (function(t) {
            t.removeAttribute("field")
        }))
    }
    if (!d && t && !s.querySelector('.t-slds__item[data-slide-index="' + (i + 1) + '"]')) {
        var f = t.cloneNode(!0);
        if (f.setAttribute("data-slide-index", i + 1), f.classList.remove("t-slds__item_active"), f.setAttribute("aria-hidden", "true"), e.insertAdjacentElement("afterend", f), e.classList.add("t-slds__item-loaded"), r > 0 && "true" === a)
            for (var y = t, m = e, v = 0; v < r - 1; v++) {
                var g = y.nextElementSibling.cloneNode(!0);
                g.setAttribute("data-slide-index", i + v + 1), m.nextElementSibling.insertAdjacentElement("afterend", g), m = m.nextElementSibling, y = y.nextElementSibling
            }
    }
    l && (n.classList.add("t-zoomable"), n.setAttribute("data-zoomable", "yes")), o && (c.classList.add("t-zoomable"), c.setAttribute("data-zoomable", "yes"))
}
...
function t_slds_setItemsInRow(t, e) {
    var s = "object" == typeof t ? t[0] : document.querySelector("#rec" + t);
    if (s) {
        var i, r = s.querySelector(".t-slds__items-wrapper");
        r && (r.getAttribute("data-slider-items-in-row") && (window.innerWidth <= 960 && (i = 2), window.innerWidth <= 640 && (i = 1), window.innerWidth > 960 && (i = e)), i && r.setAttribute("data-slider-items-in-row", i))
    }
}
...
function t_slds_initSliderControls(t, e) {
    ...
    if (s) {
        ...
        if (i) {
            ...
            var o = s.querySelectorAll(".t-slds__arrow_wrapper");
            o.length > 0 && Array.prototype.forEach.call(o, (function(r) {
                r.addEventListener("click", (function() {
                    var r = t_slds_getCurrentTranslate(s),
                        ...
                        n = "";
                    "" == a && (i.setAttribute("data-slider-animated", "yes"), "left" === this.getAttribute("data-slide-direction") ? "false" == o && 1 == d ? d = 1 : d-- : "false" == o && d == l ? d = l : d++, i.setAttribute("data-slider-pos", d), d != l + 1 && 0 != d || (n = "yes"), i.setAttribute("data-slider-cycle", n), t_slideMoveWithoutAnimation(t, !1, e, r)), t_slds_updateSlider(t)
                }))
            }));
            var n = s.querySelectorAll(".t-slds__bullet");
    ...
    if (i) {
        ...
        if (r) {
            var a = parseFloat(r.getAttribute("data-slider-pos")),
                d = (r.getAttribute("data-slider-items-in-row") || 0) > 0 ? i.querySelector(".t-slds__container .t-slds__item").offsetWidth : i.querySelector(".t-slds__container").offsetWidth,
                l = parseFloat(r.getAttribute("data-slider-totalslides")),
                o = r.classList.contains("t-slds_animated-none");
            if (a > l + 1 && (a = 1), o) {
                var n = i.querySelector(".t-slds__item_active"),
                    c = i.querySelectorAll(".t-slds__item");
                if (n && 0 === i.querySelectorAll(".t-slds__item_dummy").length) {
                    var u = n.cloneNode(!0);
                    if (u.classList.add("t-slds__item_dummy"), u.style.position = "absolute", u.style.left = d * a + "px", r.appendChild(u), i.classList.contains("js-product")) _ = i;
                    else var _ = i.querySelector(".t-store") || i.querySelector(".js-product");
                    _ ? (t_slds_fadeOut(u, 150, (function() {
            ...
            t_slideMove(t, e, s), o && r.classList.remove("t-slds_animated-cancel")
        }
    }
}
...
function t_slideMoveInstantly(t, e, s) {
    ...
    if (i) {
        ...
        if (r) {
            var a = parseFloat(r.getAttribute("data-slider-pos")),
                d = (r.getAttribute("data-slider-items-in-row") || 0) > 0 ? i.querySelector(".t-slds__container .t-slds__item").offsetWidth : i.querySelector(".t-slds__container").offsetWidth;
            if (a > parseFloat(r.getAttribute("data-slider-totalslides")) + 1 && (a = 1), r.classList.contains("t-slds_animated-none")) {
                var l = i.querySelector(".t-slds__item_active");
                if (l && 0 === i.querySelectorAll(".t-slds__item_dummy").length) {
                    var o = l.cloneNode(!0);
                    o.classList.add("t-slds__item_dummy"), o.style.position = "absolute", o.style.left = d * a + "px", r.appendChild(o), t_slds_fadeOut(o, 400, (function() {
    ...
    if (i) {
        ...
        if (r) {
            var a = i.querySelectorAll(".t-slds__item:not(.t-slds__item_dummy)"),
                ...
                p = (r.getAttribute("data-slider-cycle"), r.classList.contains("t-slds_animated-none")),
                f = r.getAttribute("data-slider-timeout") > 0,
                y = r.getAttribute("data-slider-stop"),
                m = i.querySelector(".t-slds__arrow_wrapper-right"),
                v = i.querySelector(".t-slds__arrow_wrapper-left");
            "off" === r.getAttribute("aria-live") && r.setAttribute("aria-live", "polite");
            var g = 0;
            if (/^((?!chrome|android).)*safari/i.test(navigator.userAgent)) {
                var A = navigator.appVersion.match(/Version\/(\d+)\.(\d+)\.?(\d+)? Safari/);
                null !== A && (g = parseInt(A[1], 10))
            }
            var b = !!navigator.userAgent.match("CriOS");
            if (c || 0 === c || (c = 300), u > _ + 1 && (u = 1, r.setAttribute("data-slider-pos", 1)), "true" == y) return !1;
            if (m)
                if (d) {
                    var S = a[a.length - 1],
                        h = parseInt(S.getAttribute("data-slide-index"), 10);
                    if (l < _ && t_slds_fadeIn(m, 300), h < _ && l > 0 && (u == h - o + 1 || h === o)) {
                        var w = document.createEvent("Event");
                        w.initEvent("feedsLastSlide", !0, !0), r.dispatchEvent(w), document.addEventListener("feedsLoadSlide", (function() {
                            t_slds_updateSlider(t)
                        })), t_slds_fadeIn(m, 300)
                    } else h === _ && u === _ - l + 1 && t_slds_fadeOut(m, 300)
                } else "false" == r.getAttribute("data-slider-with-cycle") && (u == _ || l > 1 && u == _ - l + 1) ? t_slds_fadeOut(m, 300) : t_slds_fadeIn(m, 300);
            v && ("false" == r.getAttribute("data-slider-with-cycle") && 1 == u ? t_slds_fadeOut(v, 300) : t_slds_fadeIn(v, 300)), r.classList.add("t-slds_animated"), g >= 13 && b && !p ? t_slide_MoveAnimation(r, u, n, c) : r.style.transform = "translateX(-" + n * u + "px)", setTimeout((function() {
                r.classList.remove("t-slds_animated"), r.setAttribute("data-slider-animated", ""), "yes" == r.getAttribute("data-slider-cycle") && (u == _ + 1 && (u = 1), 0 == u && (u = _), g >= 13 && b && !p ? t_slide_MoveAnimation(r, u, n, 0) : r.style.transform = "translateX(-" + n * u + "px)", !0 !== p && t_slds_ActiveSlide(t, u, _, s), r.setAttribute("data-slider-pos", u)), ("y" === window.lazy || document.querySelector("#allrecords") && "yes" === document.querySelector("#allrecords").getAttribute("data-tilda-lazy")) && t_slds_onHammerLoad("t_lazyload_update", (function() {
                    t_lazyload_update()
                })), !e && f && t_slds_initAutoPlay(t, u, _, s)
...
function t_slds_SliderArrowsHeight(t) {
    ...
    if (e) {
        ...
        if (s) {
            ...
            var a = parseInt(getComputedStyle(s).paddingTop) || 0,
                d = parseInt(getComputedStyle(s).paddingBottom) || 0,
                l = s.clientHeight - (a + d) - r
        }
        var o = e.querySelectorAll(".t-slds__arrow_wrapper");
        l && o.length > 0 && Array.prototype.forEach.call(o, (function(t) {
            t.style.height = l + "px";
...
function t_slds_initAutoPlay(t, e, s, i) {
    ...
    if (a) {
        ...
        if (l) {
            ...
            var _, p, f = a.getBoundingClientRect().top + window.pageYOffset;
            a.offsetHeight;
            window.addEventListener("resize", t_throttle((function() {
                f = a.getBoundingClientRect().top + window.pageYOffset, f + a.offsetHeight
                ...
                if (document[_]) l.setAttribute("data-slider-stopped", "yes");
                else {
                    var t = getComputedStyle(a).display,
                        e = window.pageYOffset,
                        s = e + window.innerHeight;
                    f = a.getBoundingClientRect().top + window.pageYOffset, f + a.offsetHeight > e && f < s && "none" !== t && "y" !== l.getAttribute("data-slider-stopped-by-video") && l.setAttribute("data-slider-stopped", "")
                }
            }), !1), 1 === a.length && window.bind("scroll", t_throttle((function() {
                var t = getComputedStyle(a).display,
                    e = window.pageYOffset,
                    s = e + window.innerHeight;
                "none" !== t ? (f = a.getBoundingClientRect().top + window.pageYOffset, f + a.offsetHeight > e && f < s && "y" !== l.getAttribute("data-slider-stopped-by-video") ? l.setAttribute("data-slider-stopped", "") : "" === l.getAttribute("data-slider-stopped") && l.setAttribute("data-slider-stopped", "yes")) : r || l.setAttribute("data-slider-stopped", "yes")
            })));
            ...
            l.setAttribute("data-slider-interval-id", y)
        }
    }
}
...
function t_slds_initSliderSwipe(t, e, s, i) {
    ...
    if (r) {
        ...
        if (a) {
            ...
            if (d) {
                var l, o = d.getAttribute("data-slider-stop"),
                    n = d.getAttribute("data-swiper-initialized"),
                    c = !1,
                    u = !1;
                if ("true" == o) return !1;
                if ("true" == n) return !1;
                ...
                if ("IntersectionObserver" in window ? new IntersectionObserver((function(t) {
                    ...
                    })).observe(r) : (_(p), window.addEventListener("scroll", (function() {
                        c = !0, clearTimeout(l), l = setTimeout((function() {
                            _(p), c = !1
                        }), 250)
                    }))), 1 == e) return !1;
                var f = function(t) {
                    ...
                    if (s.setAttribute("data-slider-touch", "yes"), t_slds_scrollImages(t, l * o - p), e.isFinal) {
                        if (e.velocityX > .4) "false" == s.getAttribute("data-slider-with-cycle") && 1 == o ? o = 1 : o--, s.setAttribute("data-slider-pos", o), 0 == o && (_ = "yes"), s.setAttribute("data-slider-cycle", _), t_slideMove(t, !1, i);
                            ...
                            if ("false" == s.getAttribute("data-slider-with-cycle") && (o == n || d && o == n - a + 1)) o = d ? n - a : n;
                                ...
                                var y = r.querySelectorAll(".t-slds__item:not(.t-slds__item_dummy)"),
                                    m = y[y.length - 1],
                                    v = parseFloat(m.getAttribute("data-slide-index"), 10);
                                if (v < n && o == v) {
                                    var g = document.createEvent("Event");
                                    g.initEvent("feedsLastSlide", !0, !0), s.dispatchEvent(g), document.addEventListener("feedsLoadSlide", (function() {
                                        t_slds_updateSlider(t)
                                    }))
                                }
                                o++
...
function t_slds_changeImageUrl(t) {
    var e, s = document.getElementById("allrecords"),
        i = s && "yes" === s.getAttribute("data-tilda-lazy"),
        r = "object" == typeof t ? t[0] : document.querySelector("#rec" + t);
    r && (e = i ? r.querySelectorAll(".t-slds__img:not([data-original])") : r.querySelectorAll(".t-slds__img"), Array.prototype.forEach.call(e, (function(t) {
    ...
    if ("function" == typeof window[t]) e();
        ...
        setTimeout((function r() {
            ...
            if ("function" != typeof window[t]) {
                if (a - i > 7e3) throw new Error(t + " is undefined");
                setTimeout(r, s || 100)
            } else e()
        }))
    }
...
function t_slds_fadeOut(t, e, s) {
    if ("none" !== t.style.display && !t.getAttribute("data-fadeout-timeout")) {
        ...
        var r = setInterval((function() {
            t.style.opacity = i, (i -= .1) <= .1 && (clearInterval(r), t.removeAttribute("data-fadeout-timeout"), t.style.display = "none", "function" == typeof s && s())
        }), e > 0 ? e / 10 : 40);
        t.setAttribute("data-fadeout-timeout", r)
    }
}
