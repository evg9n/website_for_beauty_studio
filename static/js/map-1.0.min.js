...
function t_handleGoogleApiReady(recid) {
    ...
    Array.prototype.forEach.call(gmaps, (function(gmap) {
        ...
        function t_map__attachInfoMessage(e, a) {
        ...
        if (Array.prototype.forEach.call(arMarkers, (function(e) {
                myLatLng = new google.maps.LatLng(parseFloat(e.lat), parseFloat(e.lng)), marker = new google.maps.Marker({
                    position: myLatLng,
                    map: map,
                    title: e.title
                }), bounds.extend(myLatLng), e.descr ? t_map__attachInfoMessage(marker, e.descr) : t_map__attachInfoMessage(marker, e.title)
            })), arMarkers.length > 1) {
        ...
        google.maps.event.addDomListener(window, "resize", (function() {
            var e = map.getCenter(),
                a = parseInt(mapZoomAttr, 10);
            google.maps.event.trigger(map, "resize"), map.setCenter(e), arMarkers.length > 0 && (map.fitBounds(bounds), a > 0 && (map.getZoom() > a || 0 == map.getZoom()) && map.setZoom(a))
...
function t_handleYandexApiReady(e) {
    var a = document.querySelectorAll("#rec" + e + " .t-map");
    if (!a.length) return !1;
    Array.prototype.forEach.call(a, (function(a) {
        var t = window["arMapMarkers" + e],
            o = a.getAttribute("data-map-zoom");
        window.isDragMap = !window.isMobile;
        var n = t.length > 0 && [parseFloat(t[0].lat), parseFloat(t[0].lng)],
            r = {
                zoom: parseInt(o, 10),
                center: n,
                scrollZoom: !1,
            ...
            i = new ymaps.Map(a, r),
            p = new ymaps.GeoObjectCollection({}),
            s = i.panes.get("events").getElement(),
            l = {
        ...
        Array.prototype.forEach.call(Object.keys(m), (function(e) {
            s.style[e] = m[e]
        })), i.behaviors.disable("scrollZoom"), window.isMobile && (i.behaviors.disable("drag"), ymaps.domEvent.manager.add(s, "touchmove", (function(e) {
            1 === e.get("touches").length && (s.style.transition = "opacity .3s", s.style.background = "rgba(0, 0, 0, .45)", s.textContent = l[window.browserLang] || l.EN, s.style.opacity = "1")
        })), ymaps.domEvent.manager.add(s, "touchend", (function() {
            s.style.transition = "opacity .8s", s.style.opacity = "0"
        }))), Array.prototype.forEach.call(t, (function(e) {
            var a = [parseFloat(e.lat), parseFloat(e.lng)],
                t = document.createElement("textarea");
            t.innerHTML = e.descr, p.add(new ymaps.Placemark(a, {
                hintContent: e.title,
                balloonContent: e.descr ? t.textContent : e.title
            }))
        })), i.geoObjects.add(p);
        var d = parseInt(o, 10);
        t.length > 1 ? (i.setBounds(p.getBounds(), {
            checkZoomRange: !0
        }).then((function() {
            d > 0 && (0 == i.getZoom() || i.getZoom() > d) && i.setZoom(d)
        })), d > 0 && (0 == i.getZoom() || i.getZoom() > d) && i.setZoom(d)) : d > 0 && (0 == i.getZoom() || i.getZoom() > d) && i.setZoom(d), i.events.add("sizechange", (function() {
            i.container.fitToViewport(), t.length > 1 ? i.setBounds(p.getBounds(), {
                checkZoomRange: !0
            }).then((function() {
                d > 0 && (0 == i.getZoom() || i.getZoom() > d) && i.setZoom(d)
            })) : d > 0 && (0 == i.getZoom() || i.getZoom() > d) && i.setZoom(d)
