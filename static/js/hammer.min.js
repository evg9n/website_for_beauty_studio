...
! function(t, e, i, n) {
    ...
    function h(t, e, i) {
        var n, r = e.prototype;
        (n = t.prototype = Object.create(r)).constructor = t, n._super = r, i && nt(n, i)
    }
    ...
    function E(t, e) {
        for (var i, r, s = e[0].toUpperCase() + e.slice(1), o = 0; o < rt.length;) {
            if ((r = (i = rt[o]) ? i + s : e) in t) return r;
            o++
        }
        return n
    }
        ...
        i.isFirst = !!s, i.isFinal = !!o, s && (t.session = {}), i.eventType = e,
            function(t, e) {
                ...
                var s = i.firstInput,
                    ...
                    h = e.center = b(n);
                e.timeStamp = ut(), e.deltaTime = e.timeStamp - s.timeStamp, e.angle = w(a, h), e.distance = x(a, h),
                    function(t, e) {
                        var i = e.center,
                            n = t.offsetDelta || {},
                            r = t.prevDelta || {},
                            s = t.prevInput || {};
                        e.eventType !== yt && s.eventType !== It || (r = t.prevDelta = {
                            x: s.deltaX || 0,
                            y: s.deltaY || 0
                        }, n = t.offsetDelta = {
                            x: i.x,
                ...
                e.overallVelocityX = u.x, e.overallVelocityY = u.y, e.overallVelocity = ht(u.x) > ht(u.y) ? u.x : u.y, e.scale = o ? function(t, e) {
    ...
    function C(t, e) {
        ...
        if (e.eventType != At && (h > Tt || a.velocity === n)) {
            var u = e.deltaX - a.deltaX,
                c = e.deltaY - a.deltaY,
                l = P(h, u, c);
            r = l.x, s = l.y, i = ht(l.x) > ht(l.y) ? l.x : l.y, o = D(u, c), t.lastInterval = e
    ...
    function S(t) {
        for (var e = [], i = 0; i < t.pointers.length;) e[i] = {
            clientX: at(t.pointers[i].clientX),
            clientY: at(t.pointers[i].clientY)
        }, i++;
        return {
            timeStamp: ut(),
            pointers: e,
    ...
    function O() {
        this.evEl = zt, this.evWin = Nt, this.pressed = !1, A.apply(this, arguments)
    }

    function R() {
        this.evEl = Ft, this.evWin = Wt, A.apply(this, arguments), this.store = this.manager.session.pointerEvents = []
    }

    function M() {
        this.evTarget = kt, this.evWin = Ht, this.started = !1, A.apply(this, arguments)
    }

    function z(t, e) {
        var i = T(t.touches),
            n = T(t.changedTouches);
        return e & (It | At) && (i = y(i.concat(n), "identifier", !0)), [i, n]
    }
    ...
    function X(t, e) {
        var i = T(t.touches),
            n = this.targetIds;
        if (e & (yt | Et) && 1 === i.length) return n[i[0].identifier] = !0, [i, i];
        ...
        for (r = 0; r < o.length;) n[o[r].identifier] && a.push(o[r]), e & (It | At) && delete n[o[r].identifier], r++;
    ...
    function Y() {
        ...
        this.touch = new N(this.manager, t), this.mouse = new O(this.manager, t), this.primaryTouch = null, this.lastTouches = []
    }

    function F(t, e) {
        t & yt ? (this.primaryTouch = e.changedPointers[0].identifier, W.call(this, e)) : t & (It | At) && W.call(this, e)
    }
    ...
    function H(t) {
        this.options = nt({}, this.defaults, t || {}), this.id = pt++, this.manager = null, this.options.enable = l(this.options.enable, !0), this.state = ie, this.simultaneous = {}, this.requireFail = []
    }
    ...
    function U(t) {
        return t == Pt ? "down" : t == bt ? "up" : t == Ct ? "left" : t == St ? "right" : ""
    }
    ...
    function tt(t, e) {
        this.options = nt({}, Q.defaults, e || {}), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.oldCssProps = {}, this.element = t, this.input = function(t) {
            return new(t.options.inputClass || (dt ? R : vt ? N : ft ? Y : O))(t, _)
        }(this), this.touchAction = new k(this, this.options.touchAction), et(this, !0), o(this.options.recognizers, (function(t) {
    ...
    h(O, A, {
        handler: function(t) {
            var e = Mt[t.type];
            e & yt && 0 === t.button && (this.pressed = !0), e & Et && 1 !== t.which && (e = It), this.pressed && (e & It && (this.pressed = !1), this.callback(this.manager, e, {
                pointers: [t],
                changedPointers: [t],
                pointerType: gt,
                srcEvent: t
    ...
    t.MSPointerEvent && !t.PointerEvent && (Ft = "MSPointerDown", Wt = "MSPointerMove MSPointerUp MSPointerCancel"), h(R, A, {
        handler: function(t) {
            var e = this.store,
                i = !1,
            ...
            r & yt && (0 === t.button || o) ? 0 > a && (e.push(t), a = e.length - 1) : r & (It | At) && (i = !0), 0 > a || (e[a] = t, this.callback(this.manager, r, {
                pointers: e,
                changedPointers: [t],
                pointerType: s,
                srcEvent: t
    ...
    h(M, A, {
        handler: function(t) {
            ...
            if (e === yt && (this.started = !0), this.started) {
                ...
                e & (It | At) && i[0].length - i[1].length == 0 && (this.started = !1), this.callback(this.manager, e, {
                    pointers: i[0],
                    changedPointers: i[1],
                    pointerType: mt,
                    srcEvent: t
    ...
    k.prototype = {
        set: function(t) {
            t == Bt && (t = this.compute()), Zt && this.manager.element.style && ee[t] && (this.manager.element.style[Gt] = t), this.actions = t.toLowerCase().trim()
        },
        update: function() {
        ...
        compute: function() {
            ...
            return o(this.manager.recognizers, (function(e) {
                ...
                function(t) {
                    ...
                    var e = v(t, Qt),
                        i = v(t, te);
                    return e && i ? Kt : e || i ? e ? Qt : te : v(t, Jt) ? Jt : $t
                }(t.join(" "))
        },
    ...
    H.prototype = {
        ...
        dropRecognizeWith: function(t) {
            return s(t, "dropRecognizeWith", this) || (t = V(t, this), delete this.simultaneous[t.id]), this
        },
        ...
        emit: function(t) {
            ...
            var i = this,
                n = this.state;
            se > n && e(i.options.event + L(n)), e(i.options.event), t.additionalEvent && e(t.additionalEvent), n >= se && e(i.options.event + L(n))
        },
        tryEmit: function(t) {
        ...
        recognize: function(t) {
            var e = nt({}, t);
            return c(this.options.enable, [this, e]) ? (this.state & (oe | ae | he) && (this.state = ie), this.state = this.process(e), void(this.state & (ne | re | se | ae) && this.tryEmit(e))) : (this.reset(), void(this.state = he))
        },
        process: function(t) {},
        ...
        process: function(t) {
            var e = this.state,
                ...
                n = e & (ne | re),
                r = this.attrTest(t);
            return n && (i & At || !r) ? e | ae : n || r ? i & It ? e | se : e & ne ? e | re : ne : he
        }
    }), h(G, j, {
        defaults: {
            event: "pan",
        ...
        directionTest: function(t) {
            var e = this.options,
                ...
                s = t.deltaX,
                o = t.deltaY;
            return r & e.direction || (e.direction & Dt ? (r = 0 === s ? _t : 0 > s ? Ct : St, i = s != this.pX, n = Math.abs(t.deltaX)) : (r = 0 === o ? _t : 0 > o ? bt : Pt, i = o != this.pY, n = Math.abs(t.deltaY))), t.direction = r, i && n > e.threshold && r & e.direction
        },
        attrTest: function(t) {
            return j.prototype.attrTest.call(this, t) && (this.state & ne || !(this.state & ne) && this.directionTest(t))
        },
        emit: function(t) {
        ...
        process: function(t) {
            ...
            if (this._input = t, !n || !i || t.eventType & (It | At) && !s) this.reset();
            else if (t.eventType & yt) this.reset(), this._timer = r((function() {
                this.state = oe, this.tryEmit()
            }), e.time, this);
            else if (t.eventType & It) return oe;
            return he
        },
        reset: function() {
        ...
        emit: function(t) {
            this.state === oe && (t && t.eventType & It ? this.manager.emit(this.options.event + "up", t) : (this._input.timeStamp = ut(), this.manager.emit(this.options.event, this._input)))
        }
    }), h($, j, {
        defaults: {
            event: "rotate",
        ...
        attrTest: function(t) {
            ...
            return i & (Dt | xt) ? e = t.overallVelocity : i & Dt ? e = t.overallVelocityX : i & xt && (e = t.overallVelocityY), this._super.attrTest.call(this, t) && i & t.offsetDirection && t.distance > this.options.threshold && t.maxPointers == this.options.pointers && ht(e) > this.options.velocity && t.eventType & It
        },
        emit: function(t) {
    ...
    tt.prototype = {
        ...
        recognize: function(t) {
            ...
            if (!e.stopped) {
                ...
                for (var s = 0; s < n.length;) i = n[s], 2 === e.stopped || r && i != r && !i.canRecognizeWith(r) ? i.reset() : i.recognize(t), !r && i.state & (ne | re | se) && (r = e.curRecognizer = i), s++
            }
        },
        get: function(t) {
