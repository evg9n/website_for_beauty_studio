...
function t396_doResize(t) {
    var e = t396_isOnlyScalableBrowser(),
        ...
        a = (t396_removeElementFromDOM(i ? i.querySelector(".t396__scale-style") : null), e ? (e = i ? i.querySelectorAll(".tn-atom") : [], Array.prototype.forEach.call(e, (function(t) {
            ...
            t.style.zoom = "", (t = t.querySelector(".tn-atom")) && (t.style.transformOrigin = "", t.style.fontSize = "", t.style.webkitTextSizeAdjust = "")
        }))), i ? i.querySelector(".t396__artboard") : null);
    e = "ab" + t, i = a ? a.clientWidth : 0, window.tn_window_width = document.documentElement.clientWidth, window.tn[e].scaleFactor = parseFloat((window.tn_window_width / o).toFixed(3)), window.tn_scale_factor = parseFloat((window.tn_window_width / o).toFixed(3)), window.tn_scale_offset = (i * window.tn_scale_factor - i) / 2, t396_switchResolution(t, o), t396_updateTNobj(t), t396_ab__renderView(a), e = n ? n.getAttribute("data-tilda-mode") : "";
...
function t396_setScreensTNobj(t, e) {
    var i = "ab" + t;
    (t = (window.tn[i] = {}, window.tn[i].screens = [], e.getAttribute("data-artboard-screens"))) ? (t = t.split(",")).forEach((function(t) {
...
function t396_updateTNobj(t) {
    ...
    var e = "ab" + t,
        i = (t = document.getElementById("allrecords")) && window.getComputedStyle(t).paddingLeft || "0",
        n = (i = parseInt(i, 10), t && window.getComputedStyle(t).paddingRight || "0");
    n = parseInt(n, 10);
...
function t396_switchResolution(t, e) {
    ...
    t = "ab" + t;
    var i = window.tn[t].screens[window.tn[t].screens.length - 1];
...
function t396_artboard_build(t, e) {
    ...
    t = document.getElementById("rec" + e);
    ...
    "visible" !== (a = (Array.prototype.forEach.call(a, (function(t) {
...
function t396_ab__renderView(t) {
    ...
    var o, a, r = t396_ab__getFieldValue(t, "height"),
        ...
        l = (i = !!i && "edit" === i.getAttribute("data-tilda-mode"), "window" === t396_ab__getFieldValue(t, "upscale")),
    ...
    t.setAttribute("data-artboard-proxy-min-offset-top", a), t.setAttribute("data-artboard-proxy-min-height", r), t.setAttribute("data-artboard-proxy-max-height", d), l = t.querySelector(".t396__filter"), i = t.querySelector(".t396__carrier"), _ = t396_ab__getFieldValue(t, "height_vh"), _ = parseFloat(_), window.t396__isMobile && _ && (_ = document.documentElement.clientHeight * _ / 100, t.style.height = _ + "px", l && (l.style.height = _ + "px"), i && (i.style.height = _ + "px"))
}
...
function t396_changeFilterOnSafari(t, e) {
    var i;
    !/^((?!chrome|android).)*safari/i.test(navigator.userAgent) || (i = window.getComputedStyle(t).webkitBackdropFilter) && "none" !== i && "IntersectionObserver" in window && new IntersectionObserver((function(t, i) {
        t.forEach((function(t) {
            var n;
            t.isIntersecting && (n = t.target, i.unobserve(n), n.style.webkitBackdropFilter = "none", t396_WaitForUploadImg(e, (function() {
...
function t396_elem__renderView(t) {
    t = t396_getEl(t), tn_console("func: elem__renderView");
...
function t396_elem__renderViewOneField(t, e) {
    if (t = t396_getEl(t)) {
        var i = (i = document.getElementById("allrecords")) ? i.getAttribute("data-tilda-mode") : "",
...
function t396_elem__convertPosition__Local__toAbsolute(t, e, i) {
    if (t = t396_getEl(t)) {
        var n, o, a = "ab" + (o = t.closest(".t396__artboard")).getAttribute("data-artboard-recid"),
            r = t396_ab__getFieldValue(o, "valign"),
            d = "window" === t396_ab__getFieldValue(o, "upscale"),
            l = "edit" === ((o = document.getElementById("allrecords")) ? o.getAttribute("data-tilda-mode") : ""),
        ...
        switch (i = parseInt(i), e) {
            ...
            case "top":
                ...
                m = (h = (h = t.parentNode).classList.contains("t396__artboard") ? h : h.parentNode) ? h.getAttribute("data-artboard-proxy-min-offset-top") : "0";
                var p, y = h ? h.getAttribute("data-artboard-proxy-min-height") : "0",
                    F = h ? h.getAttribute("data-artboard-proxy-max-height") : "0",
                    v = (m = (f = "grid" === g ? "grid" : "window", "grid" === g ? parseFloat(m) : 0), y = "grid" === g ? parseFloat(y) : parseFloat(F), F = ("%" === t396_elem__getFieldValue(t, "topunits") && (i = y * (i / 100)), s && "window" !== f && (i *= window.tn_scale_factor), i = (m = c && "window" !== f ? "stretch" === r ? 0 : m / window.tn_scale_factor : m) + i, t396_ab__getFieldValue(h, "height_vh")), m = t396_ab__getFieldValue(h, "height"), t396_ab__getHeight(h));
...
function t396_elem__getCorrectStylesForSafari(t, e) {
    var i = t.querySelector(".tn-atom"),
        ...
        a = i.style.fontSize;
    i.style.webkitTextSizeAdjust = "none", i.style.fontSize = "", t.style.zoom = "", e = parseFloat(window.getComputedStyle(i)[e]);
...
function t396_allelems__renderView(t) {
    if (!t) return !1;
    tn_console("func: allelems__renderView: abid:" + t.getAttribute("data-artboard-recid")), t = t.querySelectorAll(".tn-elem"), Array.prototype.forEach.call(t, (function(t) {
...
function t396_ab__filterUpdate(t) {
    var e, i, n, o;
    (t = t.querySelector(".t396__filter")) && (e = t.getAttribute("data-filtercolor-rgb"), i = t.getAttribute("data-filtercolor2-rgb"), n = t.getAttribute("data-filteropacity"), o = t.getAttribute("data-filteropacity2"), e && !i ? t.style.backgroundColor = "rgba(" + e + "," + n + ")" : !e && i ? t.style.backgroundColor = "rgba(" + i + "," + o + ")" : e && i ? t.style.background = "-webkit-gradient(linear, left top, left bottom, from(rgba(" + e + "," + n + ")), to(rgba(" + i + "," + o + ")) )" : t.style.backgroundColor = "transparent")
}

function t396_ab__getHeight(t, e) {
    return e = e || t396_ab__getFieldValue(t, "height"), e = parseFloat(e), (t = t396_ab__getFieldValue(t, "height_vh")) && (t = parseFloat(t), isNaN(t) || e < (t = window.tn.window_height * t / 100) && (e = t)), e
}

function t396_hex2rgb(t) {
    return [(16711680 & (t = parseInt(t.substring(1), 16))) >> 16, (65280 & t) >> 8, 255 & t]
}

function t396_elem__getWidth(t, e) {
    var i = "ab" + (t = t396_getEl(t)).closest(".t396__artboard").getAttribute("data-artboard-recid");
    return e = e || t396_elem__getFieldValue(t, "width"), e = parseFloat(e), "%" === t396_elem__getFieldValue(t, "widthunits") ? "window" === t396_elem__getFieldValue(t, "container") ? window.tn.window_width * e / 100 : window.tn[i].grid_width * e / 100 : e
}
...
function t396_hex2rgba(t, e) {
    return !!t && [(16711680 & (i = (3 === (i = t.replace(/#/, "")).length && (t = "#" + i[0] + i[0] + i[1] + i[1] + i[2] + i[2]), parseInt(t.substring(1), 16)))) >> 16, (65280 & i) >> 8, 255 & i, parseFloat(e)];
    var i
}
